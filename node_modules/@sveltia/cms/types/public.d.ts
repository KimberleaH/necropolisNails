...
export type ApiAsset = {
    ...
    field: any;
    /**
     * Asset file object if available.
     */
...
export type WidgetsForData = {
    /**
     * Raw values for the field.
     */
    data: unknown;
    /**
     * Widget preview elements keyed by child field
     * name.
     */
...
export type CustomPreviewBaseProps = {
    ...
    entry: MapOf<ApiEntry>;
    /**
     * Function that returns the asset item
     * for a given path. Returns `undefined` if the asset is not found.
     */
    getAsset: (path: string) => ApiAsset | undefined;
    /**
...
export type CustomPreviewTemplateBaseProps = {
     ...
     */
    widgetsFor: (keyPath: FieldKeyPath) => WidgetsForResult;
    /**
...
export type CustomFieldSchema = {
    /**
     * JSON Schema object describing the field’s
